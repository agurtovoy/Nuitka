...
class ChildrenHavingPackageOptionalEncodingOptionalErrorsOptionalResourcesTupleMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionImportlibResourcesReadTextSince313CallMixin = (
    ChildrenHavingPackageOptionalEncodingOptionalErrorsOptionalResourcesTupleMixin
)
